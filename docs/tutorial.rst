...
--------------------------
.. versionchanged:: v0.2.0rc1
    any smtp server should now be usable if you code the host and port into the yaml config file.  *Any* email can be used as the recipient. 

.. versionadded:: v0.2.0rc1
    added ``--no-email`` option. 
